    ...
    <section class="section" style="margin-top:-70px;" id="csection">
        <div class="section-header">
          ...
          <div class="section-header-button">
            <a href="{{ url('/testimonials/create') }}" class="btn btn-primary">Add New</a>
          </div>
          <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="{{ route('testimonials') }}">Testimonials</a></div>
                    ...
                    <table class="table table-striped" id="table-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><span class="text-center justify-content-center" style="padding-top:10px;">Sparkle Kidss is one of the best.</span>
                          ...
                          <td>
                              <div class="d-flex">
                              <a href="{{ url('testimonials/1')}}" class="badge badge-primary d-inline"><i class="fas fa-eye"></i>View&nbsp;&nbsp;</a>&nbsp;&nbsp;

                              <a href="{{ url('testimonials/1/edit')}}"  class="badge badge-info d-inline"><i class="fas fa-edit"></i>Edit&nbsp;&nbsp;</a>&nbsp;&nbsp;
