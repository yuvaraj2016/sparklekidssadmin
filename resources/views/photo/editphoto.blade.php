...
<section class="section" style="margin-top:-70px;">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('photos') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i>&nbsp;<b>Back</b></a>
      </div>
      <h1>Edit New Photo</h1>
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Edit New Photo</div>
      </div>
    </div>
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Photo Name</label>
                    <div class="col-sm-12 col-md-7">
