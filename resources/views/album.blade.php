    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      ...
      <li class="dropdown"><a href="{{ route('albums')}}" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            {{-- @if ($message = Session::get('access_token'))
...
@section('content')
    ...
    <section class="section" style="margin-top:-70px;" id="csection">
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Great! You have successfully logged in.</strong>
     ...
     @endif
        ...
        <div class="section-header">
          ...
          <div class="section-header-button">
            <a href="{{ url('/albums/create') }}" class="btn btn-primary">Add New</a>
          </div>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="{{url('albums/1')}}" class="badge badge-primary d-inline"><i class="fas fa-eye"></i>View&nbsp;&nbsp;</a>&nbsp;&nbsp;

                              <a href="{{url('albums/1/edit')}}"  class="badge badge-info d-inline"><i class="fas fa-edit"></i>Edit&nbsp;&nbsp;</a>&nbsp;&nbsp;
