...
<section class="section" style="margin-top:-70px;">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('albums') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i>&nbsp;<b>Back</b></a>
      </div>
      <h1>Edit New Album</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Gallery</a></div>
        <div class="breadcrumb-item"><a href="#">Albums</a></div>
        <div class="breadcrumb-item">Edit New Album</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                <form name="album" action="{{ route('albums.edit','1')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

               @if ($errors->any())
                    <div class="alert alert-danger">
                        <strong>Whoops!</strong> There is some error occured.<br><br>
                        <ul>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" name="album_date" class="form-control datepicker">
                </div>
              </div>
              <div class="form-group row mb-4">
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Cover Picture</label>
                <div class="col-sm-12 col-md-7">
