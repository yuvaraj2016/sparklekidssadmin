...
class AlbumController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return redirect('/albums/create')->with('success',"Album created successfully");
        ...
        {
            return redirect('/albums/create')->with('success','Album Successfully Created');
    ...
    public function editalb(){

        return view('album.editalbum');
    }

    public function edit(Request $request, $id)
    {
        return redirect('/albums/$id/edit')->with('success',"Album edited successfully");
